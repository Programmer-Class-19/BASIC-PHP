...
<head>
    ...
    <body>
        ...
        function tambah_barang($nama, $harga, $stock, $kategori, $totalHarga)
        {
            $_SESSION['barang'][] = [
                'nama_barang' => $nama,
                'harga' => $harga,
     ...
     <div class="table-container">
            ...
            if (!empty($_SESSION['barang'])) {
                ...
                foreach ($_SESSION['barang'] as $item) {
                    $totalHargaPerBarang = $item['harga'] * $item['stock'];
                    ...
                    echo "<td>Rp. " . $totalHargaPerBarang . "</td>";
                    echo "</tr>";
                }
                ...
                echo "<td>Rp. " . $totalKeseluruhanHarga . "</td>";
                echo "</tr>";
