...
<body>
    ...
    {
        // tambahkan barang baru ke dalam array
        $_SESSION['barang'][]= [
            'nama_barang' => $nama,
            'harga'=> $harga,
            'stok' => $stok,
    ...
    <div class="container">
        ...
        <div class="table-container">
            <h2>Daftar Barang Yang Ada Di Toko</h2>
            <?php
            ...
            if (!empty($_SESSION['barang'])) {
                ...
                echo "<td collspan='4'>Total keseluruhan harga </td>";
                echo "<td>" . $totaluang . "</td>";
