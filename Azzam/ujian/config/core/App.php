<?php
class config { //membuat property untuk menentukan default nya
    ...
    public function __construct() 
    {
        ...
        //controller
        if( isset($url[0]) && file_exists("../config/controllers/" . $url[0] . ".php")) {
            $this->controller = $url[0];
            unset($url[0]);
        }
         
        require_once "../config/controllers/" . $this->controller . ".php";
